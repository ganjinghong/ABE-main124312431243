...
public final class docToPdfUtil {
    private static final Logger logger = LoggerFactory.getLogger(docToPdfUtil.class);
//+ srcPath + " --outdir " + desPath
    public static void main(String[] args) throws NullPointerException {
        String srcPath = "C:/Users/57802/Desktop/11.doc", desPath = "C:/Users/57802/Desktop/11";
        docToPdf(srcPath, desPath);
//        String command = "";
...
//        }
    ...
    public static void docToPdf(String srcPath, String desPath) {
        String command = "";
        String osName = System.getProperty("os.name");
        if (osName.contains("Windows")) {
            command = "cmd /c soffice --headless --convert-to pdf " + srcPath + " --outdir " + desPath;
